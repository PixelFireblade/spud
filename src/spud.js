...
CircuitBoard = (function() {
  ...
  CircuitBoard.prototype.buildInspector = function(properties) {
    var $cell, $groupA, $groupB, $groupC, $groupD, $headers, $memoryContainer, $outputBtn, $refTable, $reference, $registerContainer, $registerInput, $registers, $resetBtn, $restoreBtn, $saveBtn, $generateImage, $sliderBox, $speedRunButton, $table, $uploadBtn, $valueModeToggle, changeRegister, changeRegisterDecimal, hoverRegister, i, instruction, maxRowLength, registerName, row, rowLength, self, unhoverRegister, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2,
      _this = this;
    ...
    $generateImage = $('<div class="btn btn-small">').html($('<i class="icon-picture">')).tooltip({
    ...
    $groupB.append($saveBtn).append($restoreBtn).append($resetBtn).append($generateImage);
    $groupC.append($speedRunButton);
    $groupD.append($valueModeToggle);
    this.toolbar.append($groupA).append($groupB).append($groupC).append($groupD).append();
